...
export default function FeelingsButton(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
    ...
    >
      ...
      <path fill="none" d="M0 0h24v24H0V0z" />
      <path d="M17 9.5 A1.5 1.5 0 0 1 15.5 11 A1.5 1.5 0 0 1 14 9.5 A1.5 1.5 0 0 1 17 9.5 z" />
      <path d="M10 9.5 A1.5 1.5 0 0 1 8.5 11 A1.5 1.5 0 0 1 7 9.5 A1.5 1.5 0 0 1 10 9.5 z" />
      <path d="M17 9.5 A1.5 1.5 0 0 1 15.5 11 A1.5 1.5 0 0 1 14 9.5 A1.5 1.5 0 0 1 17 9.5 z" />
      <path d="M10 9.5 A1.5 1.5 0 0 1 8.5 11 A1.5 1.5 0 0 1 7 9.5 A1.5 1.5 0 0 1 10 9.5 z" />
